...
public class BankUtil {
    ...
    public static String getBank(String cardNo){
        ...
        try {
            bankName = getNameOfBank(BankCodeUtil.getBaofooBankCode(cardNo));
        }catch (Exception e){
            System.out.println("bankUtil未找到银行卡");
        }
        if(bankName == null || bankName.isEmpty()){
            ...
            bankName = getNameOfBank(jsonObject.getString("bank"));
        }
        return bankName;
    }
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(getBank("6212261703008193003"));
