...
public class Advice {
    ...
    /**
     * 获取 手机号码 platform_advice.user_phone
     *
     * @return 手机号码
     */
    ...
    /**
     * 设置 手机号码 platform_advice.user_phone
     *
    ...
    /**
     * 获取 处理状态(0:未处理,1:已处理) platform_advice.handle_status
     *
    ...
    /**
     * 设置 处理状态(0:未处理,1:已处理) platform_advice.handle_status
     *
     * @param handleStatus 处理状态(0:未处理,1:已处理)
     */
