...
public class UpYun {
    ...
    public void downLoadFile(String filePath, OutputStream outputStream) {
        HttpActionDownload(METHOD_GET, formatPath(filePath), null,
                false, outputStream);
    }
    ...
    private void HttpActionDownload(String method, String uri, byte[] datas,
                                    boolean auto, OutputStream outputStream) {
