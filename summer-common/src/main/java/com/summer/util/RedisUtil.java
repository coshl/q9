...
public class RedisUtil {
    ...
    /**
     * 获取对应hash表里所有的key-value
     *
     * @param filed hash表名
     * @return map
     */
    public Map<Object, Object> hmget(String filed) {
        return redisTemplate.opsForHash().entries(filed);
    }
    ...
    /**
     * hash递增 如果不存在,就会创建一个 并把新增后的值返回（递增hash表里的filed值）
     *
     * @param key   hash表名
     * @param filed 字段名
     * @param by    要增加几(大于0)
     * @return
     */
    public double hincr(String key, String filed, double by) {
